<template>
  <div id="patient">
    ...
    <van-nav-bar title="患者">
      ...
      <template #right>
        <img
          src="@/assets/images/doctor202007171725 _10.png"
          alt=""
          @click="show = true"
        />
      </template>
            ...
            <van-swipe-cell v-for="item in list" :key="item.id">
                ...
                <van-col span="18">
                  ...
                  <div>
                    ...
                    <van-tag plain type="warning" v-if="item.gwname"
                      >治疗方案: 2次</van-tag
                    >
                    <van-tag plain type="danger" v-if="item.gwname"
                      >营养处方: 03次</van-tag
                    >
                  </div>
                </van-col>
              ...
              <template #right>
                ...
                <van-button
                  ...
                  text="健康日志"
                  class="TreatmentPlan"
                  @click="$router.push(`/newNutritionPrescription/${item.id}`)"
                />
              </template>
            </van-swipe-cell>
          </van-list>
